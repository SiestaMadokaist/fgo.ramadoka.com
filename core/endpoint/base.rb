class Ramadoka::Endpoint::Base
  ...
  class << self
    ...
    def route!(methodname, custom_resource = nil, &logic)
      ...
      raise SingleMethodForMultipleRoute, "#{methodname} is already routed, please refer to <put-some-url-here(TODO)>" unless routes[methodname].nil?
